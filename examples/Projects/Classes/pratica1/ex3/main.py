...
input1 = list_of_arguments[2]
input2 = list_of_arguments[3]
output = list_of_arguments[4]
...
if localorhadoop == "hadoop":
    ...
    os.system("hadoop fs -put -f /home/usermr/examples/input/gutenberg-small/" + input1 + " /user/usermr/examples/input/gutenberg-small/")
    os.system("hadoop fs -put -f /home/usermr/examples/input/gutenberg-small/" + input2 + " /user/usermr/examples/input/gutenberg-small/")

    os.system('python3 mapreduce.py -r hadoop hdfs:///user/usermr/examples/input/gutenberg-small/' + input1 +" hdfs:///user/usermr/examples/input/gutenberg-small/"+ input2 + ' -o /user' + output + ' -nr 2 -cc GzipCodec')
    ...
    os.system("python3 mapreduce.py file:///home/usermr/examples/input/gutenberg-small/"+input1+" -o "+output+" -nr 2 -cc GzipCodec")
    os.system("python3 mapreduce.py file:///home/usermr/examples/input/gutenberg-small/"+input2+" -o "+output+" -nr 2 -cc GzipCodec")
    pass
