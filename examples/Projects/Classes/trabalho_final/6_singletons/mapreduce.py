...
class SingletonWords(MRJob):
    ...
    def reducer_final(self, _, counts):
        ...
        yield "Percentage of singletons in all counts", len(self.singletons)/total_counts*100
        yield "Percentage of singletons in unique counts", len(self.singletons)/total_uniques*100
